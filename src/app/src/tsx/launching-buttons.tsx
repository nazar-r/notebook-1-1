...
const RenderingButtons = () => {
  ...
  const [registerError, setRegisterError] = useState({ emailError: "", passwordError: "" });
  ...
  const fetchingButton = async (index: number) => {
    ...
    const errorMode = index === 0 ? setLoginError : setRegisterError;
          ...
          {buttonView === index ? (
            <div className="login-page__button-hidden">
              <div className="login-page__button--text-input">
                ...
                {buttonView === 0 && loginError.emailError
                  ? <p className="login-page__button--error">{loginError.emailError}</p>
                  : <p className="login-page__button--error">{registerError.emailError}</p>}
                ...
                {buttonView === 0 && loginError.passwordError
                  ? <p className="login-page__button--error">{loginError.passwordError}</p>
                  : <p className="login-page__button--error">{registerError.passwordError}</p>}
              </div>
              <div className="login-page__additional-button-container">
                <div className="login-page__additional-button">
