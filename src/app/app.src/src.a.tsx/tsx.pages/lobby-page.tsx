        ...
        <div>
            <div className="lobby-page">
                ...
                <div className="lobby-page__text-field">
                    <div className="lobby-page__text-field--edit" onClick={handleSubmit}>
                    ...
                    <textarea className="lobby-page__text-field--input" placeholder="Apply Text" value={text} onChange={(e) => setText(e.target.value)} />
                </div>
